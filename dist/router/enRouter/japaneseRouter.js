...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filenames = (yield promises_1.default.readdir('./public/markdown/en/japanese')).sort(function (a, b) {
        return -1;
    });
    let HTMLString = '';
    ...
    for (let element of filenames) {
        const markdown = yield promises_1.default.readFile(`./public/markdown/en/japanese/${element}`, 'utf8');
...
router.get('/:param', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filenames = yield promises_1.default.readdir('./public/markdown/en/japanese');
    const fileIndex = +filenames.filter((filename) => filename.split('_')[0] === param)[0].split('_')[0] - 1;
    const filename = filenames[fileIndex];
    const markdown = yield promises_1.default.readFile(`./public/markdown/en/japanese/${filename}`, 'utf8');
